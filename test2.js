$("#submit").click(function (e) { // onclick para ativar a função - trocar para on document ready e para o search
    var validate = Validate();
    $("#weathercontainer").html(validate);
    if (validate.length == 0) {
        $.ajax({
            type: "POST",
            url: "http://api.openweathermap.org/data/2.5/weather?q=" +/* $("#citySelect").val() */+ "&appid=303bda03f4411976f702bf902ea85f54&units=metric",
            dataType: "json",
